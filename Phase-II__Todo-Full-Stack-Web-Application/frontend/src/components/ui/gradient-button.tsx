...
export const GradientButton = forwardRef<HTMLButtonElement, GradientButtonProps>(
  (
    ...
    const baseStyles =
      'relative inline-flex items-center justify-center font-semibold rounded-lg transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--accent)] disabled:opacity-50 disabled:cursor-not-allowed';
    ...
    return (
      ...
      >
        ...
        {variant !== 'outline' && (
          <span className="absolute inset-0 rounded-lg bg-white/10 opacity-0 transition-opacity duration-200 hover:opacity-100" />
        )}
      </motion.button>
    );
  }
